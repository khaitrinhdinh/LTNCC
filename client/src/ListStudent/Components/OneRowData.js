  ...
  render() {
    ...
    return (
      <tr height='30px'>
        ...
        <td className='text_center'>{student.mssv}</td>
        <td>{student.name}</td>
        ...
        <td className='text_center'>
          <Link
            to={`/home/list-students/update/${student.mssv}`}
          ...
          <button
            ...
            type='button'
            onClick={() => this.onDelete(student._id, student.mssv)}>
